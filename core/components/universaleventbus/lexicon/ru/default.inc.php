...
$_lang['setting_ueb_log_level_desc'] = 'Записи ниже уровня не пишутся: debug, info, warning, error. По умолчанию: error. Требует mxLogger.';
...
$_lang['setting_ueb_context_cookie_name'] = 'Имя куки для хранения контекста';
$_lang['setting_ueb_context_cookie_name_desc'] = 'по умолчанию: ueb_context';
